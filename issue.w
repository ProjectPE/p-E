...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div class="x-contents-content" xid="content7"></div></div></div> -->  
      ...
      <div xid="div19" style="padding:10px 15px;">
        ...
        <span xid="span18" style="font-size:xx-small;"><![CDATA[江苏 淮安 淮阴区]]></span>
      </div>
          ...
          <div component="$UI/system/components/justep/row/row" class="x-row"
            ...
            <div class="x-col" xid="col7"> 
              <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <label class="x-label" xid="label4"><![CDATA[交易圈]]></label>  
                <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
                  xid="fishpondInput" style="border:0" placeHolder="选择交易圈，获得更多曝光" bind-ref="$model.pageData.ref(&quot;fishpondName&quot;)" disabled="true"/>
              </div> 
            </div>  
      ...
      <div xid="div17" style="padding:20px;"> 
        <a component="$UI/system/components/justep/button/button" class="btn btn-default"
          label="确定发布" xid="publishBtn" style="background-color:	#00E3E3;border:none;width:100%;"
