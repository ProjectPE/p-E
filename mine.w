...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" title="我的"
        class="x-titlebar" style="color:#000040;background-color:#00E3E3;"> 
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-sm" label="马上登录" xid="loginBtn" style="margin-top:10px;border:0;background-color:	#00E3E3;" bind-visible=" $model.changeButtonLogin()" onClick="loginBtnClick">
   <i xid="i2"></i>
   ...
   <li class="list-group-item" xid="li5" style="padding:0px;">
    <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
     <div class="x-col x-col-10" xid="col4">
      <img src="./images/join(2).png" alt="" xid="image7" class="img-responsive"></img></div> 
     <div class="x-col" xid="col6">
      <span xid="span4"><![CDATA[我的积分]]></span></div> 
