...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row1">
   ...
   <div class="x-col" xid="col2"><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-block" label="确定" xid="okBtn" onClick="okBtnClick" style="width:100%;background-color:#00E3E3;">
   <i xid="i2"></i>
   <span xid="span2">确定</span></a></div>
   <div class="x-col" xid="col3"><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-block" label="取消" xid="button2" style="width:100%;background-color:#00E3E3;">
   <i xid="i3"></i>
