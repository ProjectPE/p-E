...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top1" height="52"><div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar form-inline x-toolbar-spliter" xid="toolBar1" style="background-color:	#00E3E3;border:0;margin:0;">
    ...
    <div component="$UI/system/components/bootstrap/carousel/carousel" class="x-carousel carousel x-banner" xid="carousel1">
     ...
     <div class="x-contents carousel-inner" role="listbox" component="$UI/system/components/justep/contents/contents" active="0" slidable="true" wrap="true" swipe="true" xid="bannerContents">
      <div class="x-contents-content" xid="content3">
       <img alt="" xid="image8" id="image8" class="image-wall img1 img-responsive" src="./images/main1.png"></img></div> 
      <div class="x-contents-content" xid="content4">
       <img alt="" xid="image9" id="image9" class="image-wall img1 img-responsive" src="./images/main2.png"></img></div> </div> </div> 
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3" style="padding:0">
   <div class="x-col" xid="col7"><img src="./images/main3.png" alt="" xid="image5" class="img-responsive"></img></div>
   <div class="x-col" xid="col8"><img src="./images/main3.png" alt="" xid="judicial" class="img-responsive" bind-click="judicialClick"></img></div>
   <div class="x-col" xid="col9"><img src="./images/main3.png" alt="" xid="image7" class="img-responsive"></img></div>
  <div class="x-col" xid="col10"><img src="./images/main3.png" alt="" xid="image10" class="img-responsive"></img></div></div><div xid="div1" style="height:10px;background-color:#E3E3E3;"></div><img src="./images/main4.png" alt="" xid="image11" class="img-responsive"></img><img src="./images/main5.png" alt="" xid="image12" class="img-responsive"></img><img src="./images/main6.png" alt="" xid="image13" class="img-responsive"></img><div component="$UI/system/components/justep/list/list" class="x-list " xid="list1" limit="5" data="publishData" filter=' $row.val("reverse") !="selled"'>
