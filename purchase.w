...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
   <div class="x-col" xid="col12"><span xid="span7"><![CDATA[淮安]]></span>
  <span xid="span8"><![CDATA[淮阴区]]></span><span xid="span9" style="width:1px;margin:0 5px;display:inline-block;border-left:1px solid #ddd;border-left-style:solid;border-left-width:1px;border-left-color:#C0C0C0;height:12px;"></span>
  ...
  <li xid="li1" class="list-group-item"><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1">
   <div class="x-col " xid="col5"><span xid="span6" class="pull-right"><![CDATA[聂风雨15515515555]]></span></div>
  <div class="x-col x-col-10" xid="col6"></div>
  </div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row7">
   <div class="x-col " xid="col8"><span xid="span5"><![CDATA[收货地址]]></span><span xid="span11" class="pull-right"><![CDATA[北京市东城区长安街]]></span></div>
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row8">
   <div class="x-col " xid="col16"><span xid="span12" class="pull-right"><![CDATA[天安门城楼]]></span></div>
  ...
  <div class="x-panel-bottom" xid="bottom1"><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="确定" xid="okBtn" style="margin-top:5px;color:#fff;margin-left:5%;width:90%;background-color:#00E3E3;" onClick="okBtnClick">
   <i xid="i1"></i>
