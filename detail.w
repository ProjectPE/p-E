...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1">
      <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
        xid="panel2"> 
        <div class="x-panel-top" xid="top2" style="text-align:center;background-color:#00E3E3	;"> 
        ...
        <div class="x-contents-content  x-scroll-view" xid="content3">
          <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView"
            ...
            <div class="x-scroll-content" xid="div4">
              <img src="./images/main1.png" alt="" xid="image1" class="img-responsive"></img><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1"> 
                    <div class="x-col x-col-33" xid="col1"> 
                      <span xid="span7" style="display:block;font-weight:bold;padding-left:5px;border-left-style:solid;border-left-width:medium;border-left-color:#21CDD6;font-size:xx-small;"><![CDATA[附近的交易圈]]></span>
                    </div>  
                    <div class="x-col" xid="col2" style="text-align:right;"> 
                      <span xid="span8" style="font-size:xx-small;color:#808080;text-align:right;"><![CDATA[淮阴师范学院]]></span>
                    </div>  
   ...
   <div class="media" xid="media1">
    ...
    <div class="media-body" xid="mediaBody1">
     <h5 xid="h51" style="margin-top:0"><![CDATA[淮阴师范学院]]></h5>
    ...
    <div class="media-body" xid="mediaBody3">
     <h5 xid="h52" style="margin-top:0"><![CDATA[淮阴工学院]]></h5>
     ...
     <span xid="span9" style="font-size:xx-small;"><![CDATA[人气33]]></span></div> </div></div><div xid="div7" style="border:1px solid #EBEBEB;"> 
                ...
                <div component="$UI/system/components/justep/row/row" class="x-row" xid="row11"> 
                    ...
                    <span xid="span21" style="display:block;font-weight:bold;padding-left:5px;border-left-style:solid;border-left-width:medium;border-left-color:#21CDD6;"><![CDATA[不可错过的交易圈]]></span></div> 
                  </div>
                    ...
                    <div class="x-col" xid="col9"> 
                      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row6"> 
                        ...
                        <div class="x-col" xid="col13"> 
                          <span xid="span11" style="font-size:x-small;"><![CDATA[交易圈新鲜事]]></span>
                        </div>  
